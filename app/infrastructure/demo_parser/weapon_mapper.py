...
ak47 = ["ak47", "weapon_ak47", "AK-47"]
awp = ["awp", "weapon_awp", "AWP"]
bowie_knife = ["Bowie Knife"]
c4 = ["planted_c4", "C4 Explosive"]
cz75_auto = ["CZ75-Auto"]
desert_eagle = ["deagle", "weapon_deagle", "Desert Eagle"]
dual_berettas = ["weapon_elite", "Dual Berettas"]
famas = ["famas", "weapon_famas", "FAMAS"]
five_seven = ["fiveseven", "weapon_fiveseven", "Five-SeveN"]
flashbang = ["flashbang", "weapon_flashbang", "Flashbang"]
galil_ar = ["galilar", "weapon_galilar", "Galil AR"]
glock_18 = ["glock", "weapon_glock", "Glock-18"]
he_grenade = ["hegrenade", "weapon_hegrenade", "High Explosive Grenade"]
incendiary_grenade = ["Incendiary Grenade", "weapon_incgrenade", "inferno"]
knifes = ["knife", "knife_t", "weapon_knife_t", "weapon_knife"]
m4a1_s = ["m4a1_silencer", "weapon_m4a1_silencer", "M4A1-S"]
m4a4 = ["m4a1", "weapon_m4a1", "M4A4"]
mag_7 = ["mag7", "weapon_mag7", "MAG-7"]
mp5_sd = ["mp5sd", "weapon_mp5sd", "MP5-SD"]
mp7 = ["mp7", "weapon_mp7", "MP7"]
mp9 = ["mp9", "MP9"]
molotov = ["molotov", "weapon_molotov", "Molotov"]
nova = ["nova", "weapon_nova", "Nova"]
p2000 = ["hkp2000"]
p250 = ["p250", "weapon_p250", "P250"]
p90 = ["p90", "weapon_p90", "P90"]
r8_revolver =["revolver", "weapon_revolver", "R8 Revolver"]
sawed_off = ["sawedoff", "weapon_sawedoff", "Sawed-Off"]
sg_553 = ["sg556", "weapon_sg556", "SG 553"]
smoke_grenade = ["Smoke Grenade", "weapon_smokegrenade"]
ssg_08 = ["ssg08", "weapon_ssg08", "SSG 08"]
usp_s = ["usp_silencer", "weapon_usp_silencer", "USP-S"]
xm1014 = ["xm1014", "weapon_xm1014", "XM1014"]
zeus_x27 =["Zeus x27"]
